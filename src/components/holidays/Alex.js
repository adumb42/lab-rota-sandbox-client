...
class Alex extends React.Component {
    ...
    render() {
        ...
        let booked = this.props.holidays.filter(holiday => holiday.Alex === false).length
        let swapsBooked = this.props.holidays.filter(holiday => holiday.Alex === null).length - 116
        ...
        return (
            <div className="ui raised card">
                <div className="content">
                    <div className="header">Alex Stuart</div>
                    <div className="meta">
