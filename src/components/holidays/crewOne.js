...
class CrewOne extends React.Component {
    ...
    const swapsBooked = 114 - this.props.holidays.filter(holiday => holiday.crewOne === null).length
    const remaining = 24 - booked
    ...
    (
            <div className="ui raised card">
                <div className="content">
                    <div className="header">{this.props.users[5].fullNameOne}</div>
                    <div className="meta">
