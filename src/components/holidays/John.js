...
class John extends React.Component {
    ...
    let booked = this.props.holidays.filter(holiday => holiday.John === false).length
    let swapsBooked = this.props.holidays.filter(holiday => holiday.John === null).length - 114
    ...
    return (
            <div className="ui raised card">
                <div className="content">
                    <div className="header">John Wilson</div>
                    <div className="meta">
